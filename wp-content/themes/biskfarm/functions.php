...
?>
    <script type="text/javascript">
     var stylesheetDir = '<?= get_bloginfo(""); ?>';
    </script>
<?php
}
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
    if ( '207' == event.detail.contactFormId ) {
        location = 'http://biskfarm.reputationindia.in/greeting-profile/';
    } else if ( '6' == event.detail.contactFormId ) {
        location = 'http://biskfarm.reputationindia.in/thank-you/';
		 } else if ( '236' == event.detail.contactFormId ) {
        location = 'http://biskfarm.reputationindia.in/thank-you-2/';
